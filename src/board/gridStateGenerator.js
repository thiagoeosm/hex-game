...
function GridStateGenerator() {
  ...
  return (
      ...
      <Pattern id="archer-pat" link="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRa6Yz3weZnTWYPZtfG4Xb3ItK2uqNyiG7SsQ&usqp=CAU" size={{x:7, y:7}} />
    </HexGrid>
  );
}
